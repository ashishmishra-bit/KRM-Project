...
function Form(props) {
  ...
  const streamInterSelectFunction = (e) => {
    ...
    if (e.target.value === "All" && e.target.checked) {
      ...
      //console.log(save);
      props.setStreamInterSelected(save);
  ...
  const streamPlaSelectFunction = (e) => {
    ...
    if (e.target.value === "All" && e.target.checked) {
      ...
      //console.log(save);
      props.setStreamPlaSelected(save);
    } else if (e.target.value === "All" && !e.target.checked) {
      let save = [];
    ...
    <Container disableGutters={true} maxWidth="md" className="Form">
      ...
      <div className="Form_material">
        ...
        <div className="Form_materialMain">
          ...
          <select
            onLoad={() => {
              props.setInterBatch(batchArray[1]);
              props.setPlaBatch(batchArray[1]);
            }}
